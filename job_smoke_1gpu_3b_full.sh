...
#PBS -j oe
#PBS -o /projects_vol/gp_boan/routing_H200/virl39k_smoke_1gpu_3b_full.log
...
EXPERIMENT_NAME="virl39k_smoke_1gpu_3b_full_${RUN_TIMESTAMP}"

echo "============================================"
echo "  ViRL39K Smoke Test - 1x GPU (3B) Full"
echo "  (reasoning weight + perception loss)"
echo "============================================"
