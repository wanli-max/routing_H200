...
#PBS -j oe
#PBS -o /projects_vol/gp_boan/routing_H200/virl39k_smoke_2gpu_3b_baseline.log
...
EXPERIMENT_NAME="virl39k_smoke_2gpu_3b_baseline_${RUN_TIMESTAMP}"

echo "============================================"
echo "  ViRL39K Smoke Test - 2x GPU (3B) Baseline"
