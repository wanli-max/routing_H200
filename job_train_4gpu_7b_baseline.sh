...
#PBS -j oe
#PBS -o /projects_vol/gp_boan/routing_H200/virl39k_4gpu_7b_baseline.log
...
EXPERIMENT_NAME="virl39k_4gpu_7b_baseline_${RUN_TIMESTAMP}"

echo "============================================"
echo "  ViRL39K Training - 4x GPU (7B) Baseline"
